...
# Tabela 2 e os 9 códigos de erro precisam ter sido todos exercitados.
#
...
ERROS_ESPERADOS = {
    "testes/COMPLETO.ALG": set(),           # o caso geral: tem de passar limpo
    "testes/FONTE.ALG": set(),              # o fonte da Figura 2, sem erros
    "testes/ERROS.ALG": {"ERRO1", "ERRO3", "ERRO4", "ERRO5",
                         "ERRO6", "ERRO7", "ERRO8", "ERRO9"},
    "testes/ERRO_LITERAL.ALG": {"ERRO2"},
    "testes/ERRO_COMENTARIO.ALG": {"ERRO4"},
}
